...
class Controller():
    ...
    def __init__(self, grid_size=[30,30], unit_size=10, unit_gap=1, snake_size=3, n_snakes=1, n_foods=1, rng=np.random.default_rng()):
        ...
        self.grid = Grid(grid_size, unit_size, unit_gap, rng)
